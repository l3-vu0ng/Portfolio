  ...
  return (
    <footer className="footer">
      <div className="footer__inner">
        <span className="footer__name">Le Vuong</span>
        <p className="footer__copy mono">
          Designed with passion. All rights reserved © {new Date().getFullYear()}
        </p>
        <div className="footer__socials">
          <a href="mailto:hello@levuong.dev" className="footer__social" aria-label="Email">
          ...
          <a href="https://github.com/l3-vu0ng" target="_blank" rel="noopener noreferrer" className="footer__social" aria-label="GitHub">
